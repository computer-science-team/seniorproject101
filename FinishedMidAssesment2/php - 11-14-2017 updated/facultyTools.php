  ...
  <head>
    ...
    width: 100%;'>";
		    ...
		    while($row=mysqli_fetch_assoc($queryResult)){
		        ...
		        echo "<tr><th>{$row['toolname']}</th><th>{$row['category']}</th><th id = 'temp'>{$row['url']}</th><th ><button style = ' background: red; margin-left: 30%;' type='submit' name='Add' value = {$row['url']}>Add</button></th>";
