	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
                <li><a href="../html/facultyManual.html">Manual</a></li>
...
<section class="call-to-action">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
          <a href="universityupload.php"><?php $_SESSION['runiversity']=$runiversity; ?><span class="glyphicon glyphicon-road glyphicon-large" aria-hidden="true"></span></a>
        <h3>GuideLine of success</h3>
        <p>Our site will give you easy and quick guide of success in your university for CS. </p>
      </div>
      <div class="col-md-4">
        <a href="universityupload2.php"><?php $_SESSION['runiversity']=$runiversity;  ?><span class="glyphicon glyphicon-floppy-disk glyphicon-large" aria-hidden="true"></span></a>
        <h3>List of clubs</h3>
