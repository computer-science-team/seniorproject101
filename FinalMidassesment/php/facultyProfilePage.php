...
<section class="call-to-action">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
          <a href="universityupload.php"><span class="glyphicon glyphicon-road glyphicon-large" aria-hidden="true"></span></a>
        <h3>GuideLine of success</h3>
        <p>Our site will give you easy and quick guide of success in your university for CS. </p>
      </div>
      <div class="col-md-4">
        <a href="universityupload2.php"><span class="glyphicon glyphicon-floppy-disk glyphicon-large" aria-hidden="true"></span></a>
        <h3>List of clubs</h3>
